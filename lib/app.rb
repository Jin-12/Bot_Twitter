...
def say_bonjour(client)
  ...
  5.times do
    elu = journalistes[rand(0..journalistes.size)]
    client.update("Merci pour votre role capital de relais de l'information, vous ëtes une barrières aux fake news #{elu} #bonjour_monde @the_hacking_pro")
  end
end
